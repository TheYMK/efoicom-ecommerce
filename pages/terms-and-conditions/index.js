...
const TermsAndConditionsPage = ({ router }) => {
	const head = () => (
		<Head>
			<title>Bangwé La Massiwa | Mentions légales</title>
			...
			<Layout>
				...
				<section className="section-pagetop bg-light">
					<div className="container">
						<h2 className="title-page">Mentions légales</h2>
					</div>
				</section>
				<section className="section-content bg-white padding-y">
					<div className="container">
						...
						<p>Welcome to Bangwé La Massiwa!</p>

						<p>
							These terms and conditions outline the rules and regulations for the use of EFOICOM's
							Website, located at https://www.bangwelamassiwa.com.
						</p>

						<p>
							By accessing this website we assume you accept these terms and conditions. Do not continue
							to use Bangwé La Massiwa if you do not agree to take all of the terms and conditions stated
							on this page.
						</p>
						...
						<p>
							We employ the use of cookies. By accessing Bangwé La Massiwa, you agreed to use cookies in
							agreement with the EFOICOM's Privacy Policy.{' '}
						</p>
						...
						<p>
							Unless otherwise stated, EFOICOM and/or its licensors own the intellectual property rights
							for all material on Bangwé La Massiwa. All intellectual property rights are reserved. You
							may access this from Bangwé La Massiwa for your own personal use subjected to restrictions
							set in these terms and conditions.
						</p>

						<p>You must not:</p>
						<ul>
							<li>Republish material from Bangwé La Massiwa</li>
							<li>Sell, rent or sub-license material from Bangwé La Massiwa</li>
							<li>Reproduce, duplicate or copy material from Bangwé La Massiwa</li>
							<li>Redistribute content from Bangwé La Massiwa</li>
						</ul>
						...
						<p>
							...
							information in certain areas of the website. EFOICOM does not filter, edit, publish or
							review Comments prior to their presence on the website. Comments do not reflect the views
							and opinions of EFOICOM,its agents and/or affiliates. Comments reflect the views and
							opinions of the person who post their views and opinions. To the extent permitted by
							applicable laws, EFOICOM shall not be liable for the Comments or for any liability, damages
							or expenses caused and/or suffered as a result of any use of and/or posting of and/or
							appearance of the Comments on this website.
						</p>

						<p>
							EFOICOM reserves the right to monitor all Comments and to remove any Comments which can be
						...
						<p>
							You hereby grant EFOICOM a non-exclusive license to use, reproduce, edit and authorize
						...
						<p>
							...
							visibility of the hyperlink compensates the absence of EFOICOM; and (d) the link is in the
						...
						<p>
							...
							linking to our website, you must inform us by sending an e-mail to EFOICOM. Please include
						...
						<p>
							No use of EFOICOM's logo or other artwork will be allowed for linking absent a trademark
							license agreement.
						</p>
