...
const PrivacyPolicyPage = ({ router }) => {
	const head = () => (
		<Head>
			<title>Bangwé La Massiwa | Politique de confidentialité</title>
			...
			<Layout>
				...
				<section className="section-pagetop bg-light">
					<div className="container">
						<h2 className="title-page">Politique de confidentialité</h2>
					</div>
				</section>
				<section className="section-content bg-white padding-y">
					<div className="container">
						...
						<ul>
							...
							<li>
								<p>
									<strong>Country</strong> refers to: Comoros
								</p>
							</li>
							<li>
								<p>
							...
							<li>
								<p>
									<strong>Website</strong> refers to Bangwé La Massiwa, accessible from{' '}
									<a
										href="https://www.bangwelamassiwa.com"
										rel="external nofollow noopener"
										target="_blank"
									>
										https://www.bangwelamassiwa.com
									</a>
								</p>
							</li>
							<li>
						...
						<ul>
							<li>
								<p>By email: bangwelamassiwa@gmail.com</p>
							</li>
							<li>
								<p>
									By visiting this page on our website:{' '}
									<a
										href="https://bangwelamassiwa/#contact"
										rel="external nofollow noopener"
										target="_blank"
									>
										https://bangwelamassiwa/#contact
									</a>
								</p>
							</li>
							<li>
								<p>By phone number: +269 3495555</p>
							</li>
						</ul>
					</div>
				</section>
