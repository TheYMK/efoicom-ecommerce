...
import AllProductsAndServices from '../../components/referent/AllProductsAndServices';

const AllProductsAndServicesPage = () => {
	...
	return (
		<Layout>
			<ReferentProtected>
				...
				{isApproved ? <AllProductsAndServices /> : <EvaluationSection pageLocation="allproducts" />}
			</ReferentProtected>
		</Layout>
	);
};

export default AllProductsAndServicesPage;
