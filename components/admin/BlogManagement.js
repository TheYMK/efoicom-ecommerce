    ...
    const deleteBlog = (slug) => {
        removeBlog(slug, user.token)
            ...
            .catch((err) => {
                console.log(err);
                toast.error(
                    `Oops! Nous n'avons pas pu supprimer ce blog. Veuillez réessayer!`
                );
            });
    };
                            ...
                            <td>
                                {b.blogcategories &&
                                    b.blogcategories.map((c, j) => (
                                        <div
                                            className="tag bg-dark text-white mr-2"
                                            key={j}
                                        >
                                            {c.name}
                                        </div>
                                ...
                                <div className="card-body mb-5">
                                    <div className="text-center">
                                        <button
                                            ...
                                            onClick={handleOpenBlogCreateDialog}
                                        >
                                            Écrire un article
                                        </button>
                                    </div>
